...
<body>
    ...
    <div class="card">
      ...
      <form id="survey" autocomplete="off">
        ...
        <div class="question" data-q="6">
          <div class="q-title"><b>6. ¿Qué aspecto consideras más problemáticos del transporte público?</b></div>
          <div class="options">
  ...
  <script>
    (function(){
      ...
      form.querySelectorAll('input[type="checkbox"]').forEach(c => c.addEventListener('change', updateProgress));
      ...
      form.addEventListener('submit', function(ev){
        ...
        for(let i=1;i<=totalQuestions;i++){
          ...
          if(els[0].type === 'checkbox'){
            // require at least one for checkbox groups
